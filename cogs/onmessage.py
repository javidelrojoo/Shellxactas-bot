...
class Mensajes(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if ('ya lo pasé' in message.content.lower() or 'ya lo pase' in message.content.lower() or 'ya lo pasaron' in message.content.lower() or 'inb4' in message.content.lower()) and message.author.id == 470723884166021120:
